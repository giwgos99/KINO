...
class MainController:
    ...
    def ask_initial_wallet(self):
        ...
        while deposit <= 0: # Αμυντικός προγραμματισμός: Επαναλαμβάνουμε το pop-up μέχρι να εισαχθεί ένα έγκυρο ποσό (μεγαλύτερο δηλαδή του 0)
    ...
    def ask_initial_time_between_draws(self):
        ...
        while timer_seconds <= 0: # Έναρξη της δομής επανάληψης για την εισαγωγή του χρόνου μεταξύ των κληρώσεων. Επαναλαμβάνεται μέχρι να δοθεί μια έγκυρη τιμή (μεγαλύτερη του 0)
            ...
            # είναι None, οπότε εμφανίζεται ένα μήνυμα και η μέθοδος καλεί ξανά τον εαυτό της αντί να κλείνει
            # όπως στην περίπτωση του πορτοφολιού.
